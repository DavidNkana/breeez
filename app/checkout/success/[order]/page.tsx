    ...
    <>
      <main className="mx-auto max-w-2xl px-4 py-10 pb-20 safe-bottom text-center">
        ...
        <p className="mt-2 text-sm text-brand-600">
          Thanks for shopping with Evasale. We&apos;ve sent a confirmation email.
        </p>
        ...
        <div className="mt-6 flex gap-2 justify-center">
          ...
          <Link href="/" className="inline-flex items-center rounded-md bg-accent-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-accent-600 active:bg-accent-700">
            Continue shopping
          </Link>
        </div>
      </main>
