      ...
      >
        ...
        >
          {image ? (
            ...
            <div style={{ fontSize: 24, color: '#1a1f26', fontWeight: 700 }}>Evasale</div>
          )}
        </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
            ...
            <span style={{ fontSize: 18, fontWeight: 600, color: '#cbd5e1' }}>Evasale</span>
          </div>
