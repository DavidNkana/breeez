    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 pb-20 safe-bottom">
        ...
        <div className="mt-2 flex flex-wrap gap-3">
          <a href={social.facebook} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-1.5 rounded-md border border-brand-200 bg-white px-3 py-2 text-sm text-brand-700 dark:border-brand-600 dark:bg-brand-900 dark:text-brand-200 hover:bg-brand-50 dark:hover:bg-brand-800">
          ...
          <a href={social.twitter} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-1.5 rounded-md border border-brand-200 bg-white px-3 py-2 text-sm text-brand-700 dark:border-brand-600 dark:bg-brand-900 dark:text-brand-200 hover:bg-brand-50 dark:hover:bg-brand-800">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
            X
          </a>
          <a href={social.whatsappShare} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-1.5 rounded-md border border-brand-200 bg-white px-3 py-2 text-sm text-brand-700 dark:border-brand-600 dark:bg-brand-900 dark:text-brand-200 hover:bg-brand-50 dark:hover:bg-brand-800">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
