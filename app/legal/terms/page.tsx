  ...
  return (
    <>
      <main className="mx-auto max-w-3xl px-4 py-10 pb-20 safe-bottom prose prose-sm prose-headings:text-brand-950 prose-a:text-accent-700">
        ...
        <h2>1. About Evasale</h2>
        <p>Evasale is an online retail store operated from South Africa. By using this website you agree to these terms.</p>
        ...
        <p>All content on this site (logos, images, copy, code) belongs to Evasale or our licensors. Don&apos;t copy or redistribute without permission.</p>

        <h2>8. Limitation of Liability</h2>
        <p>Evasale&apos;s total liability for any claim is limited to the amount you paid for the relevant order. We&apos;re not liable for indirect or consequential damages.</p>
