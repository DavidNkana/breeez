        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 md:gap-10">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <div className="mt-4 flex items-center gap-2" aria-label="Social links">
              <IconLink href={social.facebook} label="Evasale on Facebook">
              ...
              <IconLink href={social.twitter} label="Evasale on X (Twitter)">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </IconLink>
              <IconLink href={social.whatsappShare} label="Evasale on WhatsApp">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
