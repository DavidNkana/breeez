        ...
        {!showCustom ? (
          <div className="p-5">
            ...
            <p className="mt-1 text-xs text-brand-600 leading-relaxed">
              Necessary cookies keep your cart and login working. Optional analytics cookies help us understand how Evasale is used so we can improve it. You can choose what you allow.
            </p>
            ...
            <div className="mt-3 space-y-2 text-sm">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span>
                  ...
                  <span className="block text-xs text-brand-500">
              Anonymous usage stats so we can improve Evasale.
                  </span>
                </span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer">
