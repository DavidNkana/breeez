# Android Store Listing Text — copy-paste into Play Console
...
Guest checkout or signed-in account. Save up to 5 addresses. Track your order from confirmation through delivery. Get real-time updates via email and (soon) push notifications.
...
## Tagline (for in-app, marketing, etc.)
```
The everyday essentials, sorted.
```
...
| https://breeez-lyart.vercel.app/ | Marketing site (optional) |
| https://breeez-lyart.vercel.app/legal/privacy | Privacy policy (REQUIRED — currently Vercel subdomain, will move to breeez.shop on domain purchase) |
| support@breeez.shop | Email contact |
